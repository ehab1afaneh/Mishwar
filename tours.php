...
<script>
    ...
    function y() {
        swal(
            'Sorry!',
            'You have already added This place in your Plan ',
            'error'
        );
...
<div id="page">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
                                <div class="slider-text-inner text-center">
                                    <h2>Mishwar</h2>
                                    <h1>Tourist and Archeological places</h1>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div  id="element" class="colorlib-wrap" style="margin-bottom:0%">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="row">
                            ...
                            <script type="text/javascript">
                                ...
                                function show_2(button_id,max) {
                                    ...
                                    for(start;start<end;start++) {
                                        ...
                                        if (flag_check == 1) {
                                            ...
                                            $("#cont").append('<div class="col-md-5 col-sm-5 animate-box fadeInUp animated-fast"> <div class="hotel-entry">' +
                                                ' <a  class="hotel-img"' +
                                                ...
                                                ' </span>' +
                                                ' Reviews  ' + star1 + '</p>' +
                                                ' <h3><a id="name" href=' + websit + '>' + name + '</a></h3>' +
                                                ' <span class="place">' + address_initail +
                                                '<a  href="#this.id"   onclick="show_last_address(this.id)">.. Continues Reading</a>' +
                                                '</span>' +
                                                ' <a ' +
                                                ' </a>' +
                                                ' </div>' +
                                                ' </div>' +
                                                ' <form style="float: left;"  METHOD="POST" action="tourconf.php" > ' +
                                                ...
                                                '<input  id="name'+start+'" type="submit" name="submit"  value="Add To My Plane" class="btn btn-primary">' +

                                                '</form>'+


                                                ' <form  METHOD="POST" action="tourconf.php" > ' +
                                                '<input type="hidden" name="photo" value="'+firstPhoto+'">' +
                                                '<input type="hidden" name="email" value="<?php echo $email ?>">'+
                                                '<input type="hidden" name="name" value="<?php echo $name ?>">'+
                                                '<input type="hidden" name="place_name" value="'+name+'">' +
                                ...
                                function showDetails(placeResult, place, marker, status) {
                                    ...
                                    if (status == google.maps.places.PlacesServiceStatus.OK) {
                                        ...
                                        //alert(array1[counrer_array].place_lat);
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <ul class="pagination">
                                ...
                                <li class="active"><a id="1" href="#element" onclick="show_2(this.id)">1</a></li>
                                <li><a id="2" href="#element" onclick="show_2(this.id)">2</a></li>
                                <li><a id="3"  href="#element" onclick="show_2(this.id)">3</a></li>
                                <li><a id="4" href="#element" onclick="show_2(this.id)">4</a></li>
                                <li><a href="#element" onclick="show_2(this.id)">&raquo;</a></li>
                            </ul>
                        </div>
                    </div>
                    <script src="https://code.jquery.com/jquery-3.4.1.js"> </script>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-field">
                                                        ...
                                                        <select name="people" id="people" class="form-control" onchange="send_price()">
        ...
        <div class="place">
            <h2 class="h22"style="text-align: center;">Tourist and Archeological Places near me</h2>
            <style>
        .h22{
          font-size: 36px;

    ...
    <nav class="colorlib-nav" role="navigation">
        <div class="top-menu">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-2">
                        <div id="colorlib-logo"><a href="../user/indexphp.php">Mishwar</a></div>
                    </div>
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            <li><a href="../user/indexphp.php">Home</a></li>
        ...
        <div class="footer_copyright"  style="color: #FFFFFF;height: 30%">
            <div class="container">
                <div class="pull-left" style="color: #FFFFFF;font-size: 16px;margin-top: 3%">
                    <h5><p style="color: #FFFFFF;font-size: 16px"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->

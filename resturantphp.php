...
<script>
    ...
    function x() {
        swal(
            'Good job!',
            'Added Successfully to your restaurant \n Go To My Plan to Confirm it',
            'success'
        );
    }
    function y() {
        swal(
            'Sorry!',
            'You have already added This restaurant in your Plan ',
            'error'
        );
    ...
    function y1() {
        swal(
            'Sorry!',
            'You have already added This restaurant in your Favorite',
            'error'
        );
                            ...
                            <div id="page">
                                ...
                                <aside id="colorlib-hero" style="margin-bottom:10%">
                                    <div class="flexslider">
                                        <ul class="slides">
                                            <li style="background-image: url(images/rest.jpg);">
                                                                ...
                                                                for(start;start<end;start++) {
                                                                    ...
                                                                    if (flag_check == 1) {
                                                                        ...
                                                                        $("#cont").append('<div class="col-md-6 col-sm-6 animate-box fadeInUp animated-fast" style="margin-bottom=10px;"> <div class="hotel-entry">' +
                                                                            ...
                                                                            ' </div>' +
                                                                            '<form style="float: left;"  METHOD="POST" action="resturantconf.php" > ' +
                                                                            ...
                                                                            ' <form  METHOD="POST" action="resturantconf.php" > ' +
                                                                            '<input type="hidden" name="photo" value="'+firstPhoto+'">' +
                                                                            '<input type="hidden" name="email" value="<?php echo $email ?>">'+
                                                                            '<input type="hidden" name="name" value="<?php echo $name ?>">'+
                                                                            '<input type="hidden" name="place_name" value="'+name+'">' +
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <form method="post" class="colorlib-form-2">
                                                                    <div class="form-check">
                                                                        <input type="checkbox" class="form-check-input" id="exampleCheck4" onclick="arrange(4)">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="checkbox" class="form-check-input" id="exampleCheck3" onclick="arrange(3)">
                                                                        <label class="form-check-label" for="exampleCheck1">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="checkbox" class="form-check-input" id="exampleCheck2" onclick="arrange(2)">
                                                                        <label class="form-check-label" for="exampleCheck1">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="checkbox" class="form-check-input" id="exampleCheck0" onclick="arrange(0)">
                                                                        <label class="form-check-label" for="exampleCheck1">
                                ...
                                <footer class="footer_area" style="background-color: #000000;">
                                    <div class="footer_copyright"  style="color: #FFFFFF;height: 10%">
                                        <div class="container">
